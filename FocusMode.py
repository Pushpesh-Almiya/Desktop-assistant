...
def speak(audio):
    engine.say(audio)
    engine.runAndWait()
def is_admin(): #C:\Windows\System32\drivers\etc
    try:
...
if is_admin():
    ...
    print(current_time)
    time.sleep(2)
    website_list = ["www.facebook.com","facebook.com","www.instagram.com","instagram.com"] #Enter the websites that you want to block 
